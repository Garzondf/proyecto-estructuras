...
void Juego::ConfigurarFronteras() {
    vector<ConexionFrontera> fronteras_del_mundo = {
        ...
        // 1.3 América Central
        {"1.3", "1.9"}, {"1.3", "1.4"}, {"1.3", "2.4"},
        // 1.4 Estados Unidos Orientales
        {"1.4", "1.9"}, {"1.4", "1.7"}, {"1.4", "1.8"}, {"1.4", "1.3"},
        // 1.5 Groenlandia
        {"1.5", "1.6"}, {"1.5", "1.7"}, {"1.5", "1.8"}, {"1.5", "3.2"},
        // 1.6 Territorio Noroccidental
        {"1.6", "1.7"}, {"1.6", "1.5"},
        // 1.7 Ontario
        {"1.7", "1.6"}, {"1.7", "1.2"}, {"1.7", "1.9"}, {"1.7", "1.4"}, {"1.7", "1.8"}, {"1.7", "1.5"},
        // 1.8 Quebec
        {"1.8", "1.7"}, {"1.8", "1.4"}, {"1.8", "1.5"},
        ...
        {"2.1", "2.2"}, {"2.1", "2.3"},
        // 2.2 Brasil
        {"2.2", "2.3"}, {"2.2", "2.4"}, {"2.2", "2.1"}, {"2.2", "4.5"},
        // 2.3 Perú
        {"2.3", "2.4"}, {"2.3", "2.2"}, {"2.3", "2.1"},
        // 2.4 Venezuela
        ...
        // 3.2 Islandia
        {"3.2", "1.5"}, {"3.2", "3.1"}, {"3.2", "3.4"},
        // 3.3 Europa del Norte
        {"3.3", "3.1"}, {"3.3", "3.7"}, {"3.3", "3.5"}, {"3.3", "3.6"}, {"3.3", "3.4"},
        // 3.4 Escandinavia
        {"3.4", "3.2"}, {"3.4", "3.1"}, {"3.4", "3.3"}, {"3.4", "3.6"},
        // 3.5 Europa del Sur
        {"3.5", "3.7"}, {"3.5", "3.3"}, {"3.5", "3.6"}, {"3.5", "4.3"}, {"3.5", "5.7"}, {"3.5", "3.1" /* Nota: Italia conecta con Western Europe, manejado aparte */},
        // 3.6 Ucrania
        {"3.6", "3.4"}, {"3.6", "3.3"}, {"3.6", "3.5"}, {"3.6", "5.1"}, {"3.6", "5.7"}, {"3.6", "5.11"},
        ...
        // 4.2 África Oriental
        {"4.2", "4.5"}, {"4.2", "4.3"}, {"4.2", "5.7"}, {"4.2", "4.1"}, {"4.2", "4.6"}, {"4.2", "4.4"},
        // 4.3 Egipto
        {"4.3", "4.5"}, {"4.3", "5.7"}, {"4.3", "3.5"}, {"4.3", "4.2"},
        // 4.4 Madagascar
        {"4.4", "4.2"}, {"4.4", "4.6"},
        // 4.5 África del Norte
        {"4.5", "3.7"}, {"4.5", "4.3"}, {"4.5", "4.2"}, {"4.5", "4.1"}, {"4.5", "2.2"},
        // 4.6 África del Sur
        ...
        // 5.2 China
        {"5.2", "5.11"}, {"5.2", "5.10"}, {"5.2", "5.8"}, {"5.2", "5.9"}, {"5.2", "5.3"}, {"5.2", "5.1"},
        // 5.3 India
        {"5.3", "5.7"}, {"5.3", "5.1"}, {"5.3", "5.2"}, {"5.3", "5.9"},
        // 5.4 Irkutsk
        {"5.4", "5.10"}, {"5.4", "5.12"}, {"5.4", "5.6"}, {"5.4", "5.8"},
        // 5.5 Japón
        {"5.5", "5.6"}, {"5.5", "5.8"},
        // 5.6 Kamchatka
        {"5.6", "1.1"}, {"5.6", "5.12"}, {"5.6", "5.4"}, {"5.6", "5.8"}, {"5.6", "5.5"},
        // 5.7 Medio Oriente
        {"5.7", "3.6"}, {"5.7", "3.5"}, {"5.7", "4.3"}, {"5.7", "4.2"}, {"5.7", "5.3"}, {"5.7", "5.1"},
        // 5.8 Mongolia
        {"5.8", "5.10"}, {"5.8", "5.4"}, {"5.8", "5.6"}, {"5.8", "5.5"}, {"5.8", "5.2"},
        // 5.9 Siam
        {"5.9", "5.2"}, {"5.9", "5.3"}, {"5.9", "6.2"},
        // 5.10 Siberia
        {"5.10", "5.11"}, {"5.10", "5.12"}, {"5.10", "5.4"}, {"5.10", "5.8"}, {"5.10", "5.2"},
        // 5.11 Ural
        {"5.11", "3.6"}, {"5.11", "5.1"}, {"5.11", "5.2"}, {"5.11", "5.10"},
        // 5.12 Yakutsk
